package com.user.demo.SecurityConfig;

import com.user.demo.UserService.MyUserDetailsService;
...
// this method is for JPA-Mysql AUTHENTICATION Config
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        try {
            ...
            log.info("UsernameNotFoundException here");
        }
    }
// this method is for AUTHORIZATION config
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().
                disable()
                .authorizeRequests()
                .antMatchers("/users/byUsername/*").permitAll()
                .antMatchers("/users/maxStudID").permitAll()
